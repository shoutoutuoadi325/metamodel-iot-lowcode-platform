...
export const exportDeviceModelHass = (id: string) => api.get(`/api/device-models/${id}/export/hass`);
export const exportDeviceModelKubeEdge = (id: string) => api.get(`/api/device-models/${id}/export/kubeedge`);
